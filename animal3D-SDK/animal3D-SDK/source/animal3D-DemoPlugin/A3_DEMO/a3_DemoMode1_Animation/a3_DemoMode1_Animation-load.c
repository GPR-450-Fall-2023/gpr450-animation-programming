...
void a3animation_init_animation(a3_DemoState const* demoState, a3_DemoMode1_Animation* demoMode)
{
	...
	pointSet[1].x = (a3real).1;
	pointSet[1].y = (a3real).5;
	pointSet[2].x = (a3real).6;
	pointSet[2].y = (a3real).7;
	pointSet[3].x = (a3real).9;
	pointSet[3].y = (a3real).2;
	pointSet[4].x = (a3real)0;
	pointSet[4].y = (a3real).1;
	pointSet[5].x = (a3real).7;
	pointSet[5].y = (a3real).2;
	pointSet[6].x = (a3real).8;
	pointSet[6].y = (a3real).3;
	pointSet[7].x = (a3real).9;
	pointSet[7].y = (a3real)0;
	pointSet[8].x = (a3real).6;
	pointSet[8].y = (a3real).1;
	...
	pointSet[13].y = (a3real).4;
	pointSet[14].x = (a3real).3;
	pointSet[14].y = (a3real).5;
	pointSet[15].x = (a3real)1;
